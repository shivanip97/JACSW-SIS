...
<body>
    ...
    <div id="steps" align="center">
				...
				<form id="studentForm" method="post" action="EditCurrentStudent.asp?UIN=' + this.value; " value='<% Response.write rs("UIN") %>'>
                    <fieldset class="step">
                <legend></legend>
                    <p>
					...
					<input type="text" name="maidenname" required id="maidenname" value= "<%Response.write rs("PreferredFirstName") %>" readonly=true/>                  
                    <label>Gender</label>
					...
					<input type="text" name="workphone" class="homephone" required id="workphone" value='<%Response.write rs("workphone") %>' readonly=true/>
                    <label>International Phone</label>
					<input type="text" name="internationalphonenumber" class="homephone" id="internationalphonenumber" value='<%Response.write rs("InternationalPhoneNumber") %>' readonly=true/>
                    <br/><br/><br/><br/>
                    
                    <label>Cell Phone</label>
					<input type="text" name="cellphone" class="cellphone"  id="homephone" value='<%Response.write rs("workphone") %>' readonly=true/>
                    ...
                    <button type="submit" name="Button1" onclick="this.form.action='EditCurrentStudent1.asp?UIN=' + this.value; this.forms.submit();" value=<% Response.write rs("UIN") %>>Edit Student</button><br /><br />
                    <button type="submit" name="Submit" onclick="this.form.action='RemoveStudentConfirmation.asp?UIN=' + this.value; this.forms.submit();" value='<% Response.write rs("UIN") %>'>Remove Student</button><br /><br />
					...
					<input type="text" name="Withdrawn"  id="Withdrawn" value='<%Response.write rs("Withdrawn") %>' readonly=true/>   
                   ...
                   <label>Decision</label>
                    ...
                    <br/><br/><br/><br/>
                    <label>Status</label>
					<input type="text" name="Status"  id="Status" value='<%Response.write rs("Status") %>' readonly=true/> 
                    ...
                    <label style="padding-left:40px">Modified Plan</label>
                    <input type="checkbox" disabled="disabled" style="margin:0;width:20px;height:20px;margin-right: 140px;" name="ModifiedPlan" id="ModifiedPlan" class="checkboxField" value='<%Response.write rs("ModifiedPlan") %>' />
                    <br/><br/><br/><br/>
					...
					<input type="text" name="WithdrawnTerm"  id="WithdrawnTerm" value='<%Response.write rs("WithdrawnTerm") %>' readonly=true/> 
                    <br/><br/><br/><br/><br/><br/>
                    ...
                    <input type="text" name="ConfirmedDueDate" class="date" required id="ConfirmedDueDate" value='<%Response.write rs("ConfirmedDueDate") %>' readonly=true />
    ...
    <div id="steps" align="center">
                ...
                <legend></legend>
                    ...
                    <label>Cell Phone</label>
					<input type="text" name="cellphone" required id="homephone" value='<%Response.write rs("workphone") %>' readonly=true/>
                        <label>UIC Email</label>
					<input type="text" name="email" id="email" value='<%Response.write rs("email") %>' readonly=true/>
                    <label>Limited Status</label>
					<input type="text" name="LimitedStatus" required id="LimitedStatus" value='<%Response.write rs("LimitedStatus") %>' readonly=true/>
                   ...
                   <label>Decision</label>
                    ...
                    <button type="submit" name="Button1" onclick="this.form.action='EditCurrentStudent.asp?UIN=' + this.value; this.forms.submit();" value='<% Response.write rs("UIN") %>'>Edit Student</button><br /><br />
                    <button type="submit" name="Submit" onclick="this.form.action='RemoveStudentConfirmation.asp?UIN=' + this.value; this.forms.submit();" value='<% Response.write rs("UIN") %>'>Remove Student</button><br /><br />
