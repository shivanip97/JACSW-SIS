...
<title>SIS | CURRENT STUDENTS</title>
...
<div align="center"><form action="" method="post"> 
    ...
    <strong><font size = 5px> <label >Current Students</label></font></strong><br /><br /><br />
     <div id="search">
    ...
    <tbody>
     <%
					...
					course_query="select * from CurrentStudents where Confirmed = 'Y' or Confirmed = 'Yes' and Graduated is null or Graduated in ('N','') order by LastName"
         '
		...
		<tr>
            ...
            <td align="center"><div class="edit" id="<%= uin%> AdmitTerm"> <% Response.write rs("AdmitTerm") %></div></td>
            <td align="center"><div> <% Response.write rs("programtype") %></div></td>
