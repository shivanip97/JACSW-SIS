...
<div align="center"><form action="" method="post"> 
   ...
   <strong><font size = 5px> <label >Field Students</label></font></strong><br /><br /><br />
     <div id="search">
	...
	<thead>
		<tr>
            ...
            <th align="center">Prefered First Name</th>
    ...
    <tbody>
     <%
					...
					course_query="select * from CurrentStudents where ForwardtoField = 'Y' and (Graduated is Null or Graduated = ' ' or Graduated = '' or Graduated <> 'Y') and Withdrawn <> 'Y' and Decision <> 'DF'  order by LastName"
		...
		<tr>
            ...
            <td><button type="submit" name="Button1" onclick="this.form.action='ViewFieldNew.asp?UIN=' + this.value; this.forms.submit();" value='<% Response.write(uin) %>'>Show Field Information</button></td>
