 ...
 <div id="wrapper">
    ...
    <div id="steps" align="center">
                ...
                <legend></legend>
                    ...
                    <option value="Fall 2018">Fall 2017</option>
                    <option value="Fall 2019">Fall 2018</option>
                    ...
                    <select name="GraduationTermAppliedFor" id="Select5">
                    ...
                    <label>ConfirmedDueDate (MM/DD/YYYY)</label>
					...
					<button type="submit" name="Submit" onclick="this.form.action='AfterEditCurrentStudent.asp?UIN=' + this.value; this.forms.submit();" value=<% Response.write rs("UIN") %>>Save Changes</button><br /><br />
					<br/><br/>
                      </fieldset>
