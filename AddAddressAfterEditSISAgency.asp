...
<body>
    ...
    <div id="steps" >
				<form id="agencyaddressForm" method="post" action="SaveAfterEditSISAgency.asp?AgencyID='<%Response.write(AgencyID) %>'">
                ...
                <p>
					...
					<input type="text" name="AddressL1"  id="AddressL1" value='' />
                    ...
                    <label>ZipCode</label>
					<input type="text" name="Zip" class="zip"  id="Zip" value='' />
                   
                        <br/><br/><br/>
                     <br/><br/><br/>
                    </p>
                    <br/><br/>
                     <button type="submit" name="Submit" onclick="this.form.action='SaveAfterAddAddressSISAgency.asp?AgencyID=' + this.value; this.forms.submit();" value='<%Response.write(AgencyID) %>'>Save</button>
