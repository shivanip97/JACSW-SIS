...
<body>
    ...
    <div id="steps" >
				<form id="agencyfacultyForm" method="post" action="DeleteSupervisorConfirmation.asp?AgencyID='<%Response.write(AgencyID) %>'">
...
%>
                    ...
                    <button type="submit" name="SubmitDelete" onclick="this.form.action='DeleteSupervisorConfirmation.asp?SupervisorID=' + this.value; this.forms.submit();" value='<% Response.write rs("supID") %>'>Delete</button>
                    </p>
