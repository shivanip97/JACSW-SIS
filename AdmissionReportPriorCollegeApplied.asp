...
pdf.ChapterTitle2(" Report 4-Admissions Report -"&Termsel& "- Applied - Confirmed - Prior College "&LastUpdatedDt&" "&LastUpdatedTime)
...
'//////// Albion College Students ////////////
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_albion_query="SELECT Count(distinct UIN) albion_cnf_students FROM Applicants where UGCollege = 'Albion College' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					albioncnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Albion College' and term_cd='"&AdmitTerm&"'"
...
'//////// American Military University Students ////////////
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_americanMilitary_query="SELECT Count(distinct UIN) americanMilitary_cnf_students FROM Applicants where UGCollege = 'American Military University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					americanMilitarycnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'American Military University' and term_cd='"&AdmitTerm&"'"
...
'//////// American University Students ////////////
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_american_query="SELECT Count(distinct UIN) american_cnf_students FROM Applicants where UGCollege = 'American University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					americancnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'American University' and term_cd='"&AdmitTerm&"'"
...
'////////Andrew University Students ////////////

    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_andrew_query="SELECT Count(distinct UIN) andrew_cnf_students FROM Applicants where UGCollege = 'Andrews University' and Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					andrewcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Andrews University' and term_cd='"&AdmitTerm&"'"
...
'rs.Open query,conn
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_auburn_query="SELECT Count(distinct UIN) auburn_cnf_students FROM Applicants where UGCollege = 'Auburn University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					auburncnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Auburn University' and term_cd='"&AdmitTerm&"'"
 ...
 rs.close 
  ...
  Else
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_augustana_query="SELECT Count(distinct UIN) augustana_cnf_students FROM Applicants where UGCollege = 'Augustana College' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					augustanacnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Augustana College' and term_cd='"&AdmitTerm&"'"
...
'//////// Aurora Students ////////////
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_aurora_query="SELECT Count(distinct UIN) aurora_cnf_students FROM Applicants where UGCollege = 'Aurora University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					auroracnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Aurora University' and term_cd='"&AdmitTerm&"'"
...
'//////// Azusa Pacific University Students ////////////
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_azusa_query="SELECT Count(distinct UIN) azusa_cnf_students FROM Applicants where UGCollege = 'Azusa Pacific University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					azusacnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Azusa Pacific University' and term_cd='"&AdmitTerm&"'"
...
'//////// Baylor University Students ////////////
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_baylor_query="SELECT Count(distinct UIN) baylor_cnf_students FROM Applicants where UGCollege = 'Baylor University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					baylorcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Baylor University' and term_cd='"&AdmitTerm&"'"
...
'//////// Bellevue University Students ////////////
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_Bellevue_query="SELECT Count(distinct UIN) Bellevue_cnf_students FROM Applicants where UGCollege = 'Bellevue University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					Bellevuecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Bellevue University' and term_cd='"&AdmitTerm&"'"
...
'//////// Beloit College Students ////////////
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_beloit_query="SELECT Count(distinct UIN) beloit_cnf_students FROM Applicants where UGCollege = 'Beloit College' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					beloitcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Beloit College' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_Benedictine_query="SELECT Count(distinct UIN) benedictine_cnf_students FROM Applicants where UGCollege = 'Benedictine University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					benedictinecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Benedictine University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_bethel_query="SELECT Count(distinct UIN) bethel_cnf_students FROM Applicants where UGCollege = 'Bethel University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					bethelcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Bethel University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_bowlinggreenstate_query="SELECT Count(distinct UIN) bowlinggreenstate_cnf_students FROM Applicants where UGCollege = 'Bowling Green State University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					bowlinggreenstatecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Bowling Green State University' and term_cd='"&AdmitTerm&"'"
...
'////////  Bradley Students ////////////
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_bradley_query="SELECT Count(distinct UIN) bradley_cnf_students FROM Applicants where UGCollege = 'Bradley University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					bradleycnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Bradley University' and term_cd='"&AdmitTerm&"'"
...
'//////// Brandeis Students ////////////
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_brandeis_query="SELECT Count(distinct UIN) brandeis_cnf_students FROM Applicants where UGCollege = 'Brandeis University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					brandeiscnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Brandeis University' and term_cd='"&AdmitTerm&"'"
...
'//////// Brigham Young University Students ////////////
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_brigham_query="SELECT Count(distinct UIN) brigham_cnf_students FROM Applicants where UGCollege = 'Brigham Young University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					brighamcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Brigham Young University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_buenavista_query="SELECT Count(distinct UIN) buenavista_cnf_students FROM Applicants where UGCollege = 'Buena Vista University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					buenavistacnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Buena Vista University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_butler_query="SELECT Count(distinct UIN) butler_cnf_students FROM Applicants where UGCollege = 'Butler University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					butlercnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Butler University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_fullerton_query="SELECT Count(distinct UIN) fullerton_cnf_students FROM Applicants where UGCollege = 'California State University Fullerton' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					fullertoncnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'California State University Fullerton' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_losangeles_query="SELECT Count(distinct UIN) losangeles_cnf_students FROM Applicants where UGCollege = 'California State University Los Angeles' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					losangelescnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'California State University Los Angeles' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_bernardino_query="SELECT Count(distinct UIN) bernardino_cnf_students FROM Applicants where UGCollege = 'California State University San Bernardino' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					bernardinocnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'California State University San Bernardino' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_calvin_query="SELECT Count(distinct UIN) calvin_cnf_students FROM Applicants where UGCollege = 'Calvin College' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					calvincnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Calvin College' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_carleton_query="SELECT Count(distinct UIN) carleton_cnf_students FROM Applicants where UGCollege = 'Carleton College' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					carletoncnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Carleton College' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_carnegie_query="SELECT Count(distinct UIN) carnegie_cnf_students FROM Applicants where UGCollege = 'Carnegie Mellon University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					carnegiecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Carnegie Mellon University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_carthage_query="SELECT Count(distinct UIN) carthage_cnf_students FROM Applicants where UGCollege = 'Carthage College' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					carthagecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Carthage College' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_casewestern_query="SELECT Count(distinct UIN) casewestern_cnf_students FROM Applicants where UGCollege = 'Case Western Reserve University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					casewesterncnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Case Western Reserve University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_chicagostate_query="SELECT Count(distinct UIN) chicagostate_cnf_students FROM Applicants where UGCollege = 'Chicago State University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					chicagostatecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Chicago State University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_chungang_query="SELECT Count(distinct UIN) chungang_cnf_students FROM Applicants where UGCollege = 'Chung-Ang University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					chungangcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Chung-Ang University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_clarkatlanta_query="SELECT Count(distinct UIN) clarkatlanta_cnf_students FROM Applicants where UGCollege = 'Clark Atlanta University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					clarkatlantacnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Clark Atlanta University' and term_cd='"&AdmitTerm&"'"
 ...
 rs.close    
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_clarke_query="SELECT Count(distinct UIN) clarke_cnf_students FROM Applicants where UGCollege = 'Clarke University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					clarkecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Clarke University' and term_cd='"&AdmitTerm&"'"
 ...
 rs.close 
  ...
  Else
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_colgate_query="SELECT Count(distinct UIN) colgate_cnf_students FROM Applicants where UGCollege = 'Colgate University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					colgatecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Colgate University' and term_cd='"&AdmitTerm&"'"
 ...
 rs.close 
  ...
  Else
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_scholastica_query="SELECT Count(distinct UIN) scholastica_cnf_students FROM Applicants where UGCollege = 'College of St Scholastica' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					scholasticacnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'College of St Scholastica' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_coloradostate_query="SELECT Count(distinct UIN) coloradostate_cnf_students FROM Applicants where UGCollege = 'Colorado State University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					coloradostatecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Colorado State University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_columbiamissouri_query="SELECT Count(distinct UIN) columbiamissouri_cnf_students FROM Applicants where UGCollege = 'Columbia College - Missouri' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					columbiamissouricnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Columbia College - Missouri' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_columbiacollege_query="SELECT Count(distinct UIN) columbiacollege_cnf_students FROM Applicants where UGCollege = 'Columbia College Chicago' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					columbiacollegecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Columbia College Chicago' and term_cd='"&AdmitTerm&"'"
...
'////////  Concordia Students ////////////
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_concordia_query="SELECT Count(distinct UIN) concordia_cnf_students FROM Applicants where UGCollege = 'Concordia University River Forest' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					concordiacnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Concordia University River Forest' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_creighton_query="SELECT Count(distinct UIN) creighton_cnf_students FROM Applicants where UGCollege = 'Creighton University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					creightoncnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Creighton University' and term_cd='"&AdmitTerm&"'"
...
'//////// DePaul Students ////////////
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_depaul_query="SELECT Count(distinct UIN) depaul_cnf_students FROM Applicants where UGCollege = 'De Paul University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					depaulcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'De Paul University' and term_cd='"&AdmitTerm&"'"
 ...
 rs.close 
  ...
  Else
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_denison_query="SELECT Count(distinct UIN) denison_cnf_students FROM Applicants where UGCollege = 'Denison University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					denisoncnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Denison University' and term_cd='"&AdmitTerm&"'"
 ...
 rs.close 
  ...
  Else
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_depauw_query="SELECT Count(distinct UIN) depauw_cnf_students FROM Applicants where UGCollege = 'DePauw University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					depauwcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'DePauw University' and term_cd='"&AdmitTerm&"'"
 ...
 rs.close 
  ...
  Else
    ...
    '//////// Dominican Students ////////////
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_dominican_query="SELECT Count(distinct UIN) dominican_cnf_students FROM Applicants where UGCollege = 'Dominican University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					dominicancnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Dominican University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_eastwest_query="SELECT Count(distinct UIN) eastwest_cnf_students FROM Applicants where UGCollege = 'East West University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					eastwestcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'East West University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_easternillinois_query="SELECT Count(distinct UIN) easternillinois_cnf_students FROM Applicants where UGCollege = 'Eastern Illinois University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					easternillinoiscnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Eastern Illinois University' and term_cd='"&AdmitTerm&"'"
 ...
 rs.close    
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_elhurst_query="SELECT Count(distinct UIN) elhurst_cnf_students FROM Applicants where UGCollege = 'Elhurst College' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					elhurstcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Elhurst College' and term_cd='"&AdmitTerm&"'"
 ...
 rs.close 
  ...
  Else
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_elmhurst_query="SELECT Count(distinct UIN) elmhurst_cnf_students FROM Applicants where UGCollege = 'Elmhurst College' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					elmhurstcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Elmhurst College' and term_cd='"&AdmitTerm&"'"
 ...
 rs.close 
  ...
  Else
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_elon_query="SELECT Count(distinct UIN) elon_cnf_students FROM Applicants where UGCollege = 'Elon University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					eloncnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Elon University' and term_cd='"&AdmitTerm&"'"
 ...
 rs.close 
  ...
  Else
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_emmanuel_query="SELECT Count(distinct UIN) emmanuel_cnf_students FROM Applicants where UGCollege = 'Emmanuel College' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					emmanuelcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Emmanuel College' and term_cd='"&AdmitTerm&"'"
 ...
 rs.close 
  ...
  Else
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_evangel_query="SELECT Count(distinct UIN) evangel_cnf_students FROM Applicants where UGCollege = 'Evangel University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					evangelcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Evangel University' and term_cd='"&AdmitTerm&"'"
 ...
 rs.close 
  ...
  Else
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_floridastate_query="SELECT Count(distinct UIN) floridastate_cnf_students FROM Applicants where UGCollege = 'Florida State University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					floridastatecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Florida State University' and term_cd='"&AdmitTerm&"'"
 ...
 rs.close 
  ...
  Else
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_fontbonne_query="SELECT Count(distinct UIN) fontbonne_cnf_students FROM Applicants where UGCollege = 'Fontbonne University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					fontbonnecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Fontbonne University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_george_query="SELECT Count(distinct UIN) george_cnf_students FROM Applicants where UGCollege = 'George Fox University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					georgecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'George Fox University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_georgia_query="SELECT Count(distinct UIN) georgia_cnf_students FROM Applicants where UGCollege = 'Georgia State University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					georgiacnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Georgia State University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_goshen_query="SELECT Count(distinct UIN) goshen_cnf_students FROM Applicants where UGCollege = 'Goshen College' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					goshencnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Goshen College' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_gordon_query="SELECT Count(distinct UIN) gordon_cnf_students FROM Applicants where UGCollege = 'Gordon College' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					gordoncnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Gordon College' and term_cd='"&AdmitTerm&"'"
...
'rs.Open query,conn
    ...
    '//////// Governors Students ////////////
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_governors_query="SELECT Count(distinct UIN) governors_cnf_students FROM Applicants where UGCollege = 'Governors State University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					governorscnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Governors State University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_grandvalleystate_query="SELECT Count(distinct UIN) grandvalleystate_cnf_students FROM Applicants where UGCollege = 'Grand Valley State University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					grandvalleystatecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Grand Valley State University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_greenville_query="SELECT Count(distinct UIN) greenville_cnf_students FROM Applicants where UGCollege = 'Greenville College' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					greenvillecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Greenville College' and term_cd='"&AdmitTerm&"'"
...
'////////  Grinnell Students ////////////
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_grinnell_query="SELECT Count(distinct UIN) grinnell_cnf_students FROM Applicants where UGCollege = 'Grinnell College' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					grinnellcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Grinnell College' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_guilford_query="SELECT Count(distinct UIN) guilford_cnf_students FROM Applicants where UGCollege = 'Guilford College' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					guilfordcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Guilford College' and term_cd='"&AdmitTerm&"'"
...
'//////// Hamline University Students ////////////
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_hamline_query="SELECT Count(distinct UIN) hamline_cnf_students FROM Applicants where UGCollege = 'Hamline University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					hamlinecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Hamline University' and term_cd='"&AdmitTerm&"'"
...
'//////// Hebrew Students ////////////
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_hebrew_query="SELECT Count(distinct UIN) hebrew_cnf_students FROM Applicants where UGCollege = 'Hebrew University of Jerusalem' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					hebrewcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Hebrew University of Jerusalem' and term_cd='"&AdmitTerm&"'"
...
'//////// Hope College Students ////////////
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_hope_query="SELECT Count(distinct UIN) hope_cnf_students FROM Applicants where UGCollege = 'Hope College' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					hopecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Hope College' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_houghton_query="SELECT Count(distinct UIN) houghton_cnf_students FROM Applicants where UGCollege = 'Houghton College' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					houghtoncnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Houghton College' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_howard_query="SELECT Count(distinct UIN) howard_cnf_students FROM Applicants where UGCollege = 'Howard University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					howardcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Howard University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_illinoisstate_query="SELECT Count(distinct UIN) illinoisstate_cnf_students FROM Applicants where UGCollege = 'Illinois State University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					illinoisstatecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Illinois State University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_illinoiswesleyan_query="SELECT Count(distinct UIN) illinoiswesleyan_cnf_students FROM Applicants where UGCollege = 'Illinois Wesleyan University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					illinoiswesleyancnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Illinois Wesleyan University' and term_cd='"&AdmitTerm&"'"
 ...
 rs.close    
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_indianastate_query="SELECT Count(distinct UIN) indianastate_cnf_students FROM Applicants where UGCollege = 'Indiana State University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					indianastatecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Indiana State University' and term_cd='"&AdmitTerm&"'"
 ...
 rs.close 
  ...
  Else
    ...
    '//////// Indiana Students ////////////
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_indiana_query="SELECT Count(distinct UIN) indiana_cnf_students FROM Applicants where UGCollege = 'Indiana University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					indianacnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Indiana University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_indianabloomington_query="SELECT Count(distinct UIN) indianabloomington_cnf_students FROM Applicants where UGCollege = 'Indiana University Bloomington' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					indianabloomingtoncnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Indiana University Bloomington' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_indianasouthbend_query="SELECT Count(distinct UIN) indianasouthbend_cnf_students FROM Applicants where UGCollege = 'Indiana University South Bend' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					indianasouthbendcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Indiana University South Bend' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_indianaWesleyan_query="SELECT Count(distinct UIN) indianaWesleyan_cnf_students FROM Applicants where UGCollege = 'Indiana Wesleyan University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					indianaWesleyancnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Indiana Wesleyan University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_isu_query="SELECT Count(distinct UIN) isu_cnf_students FROM Applicants where UGCollege = 'Iowa State University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					isucnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Iowa State University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_ithaca_query="SELECT Count(distinct UIN) ithaca_cnf_students FROM Applicants where UGCollege = 'Ithaca College' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					ithacacnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Ithaca College' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_johncarroll_query="SELECT Count(distinct UIN) johncarroll_cnf_students FROM Applicants where UGCollege = 'John Carroll University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					johncarrollcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'John Carroll University' and term_cd='"&AdmitTerm&"'"
...
'////////  Kalamazoo Students ////////////
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_kalamazoo_query="SELECT Count(distinct UIN) kalamazoo_cnf_students FROM Applicants where UGCollege = 'Kalamazoo College' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					kalamazoocnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Kalamazoo College' and term_cd='"&AdmitTerm&"'"
...
'//////// Kansas Students ////////////
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_kansas_query="SELECT Count(distinct UIN) kansas_cnf_students FROM Applicants where UGCollege = 'Kansas State University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					kansascnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Kansas State University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_Keene_query="SELECT Count(distinct UIN) Keene_cnf_students FROM Applicants where UGCollege = 'Keene State College' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					Keenecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Keene State College' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_kendall_query="SELECT Count(distinct UIN) kendall_cnf_students FROM Applicants where UGCollege = 'Kendall College' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					kendallcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Kendall College' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_kentucky_query="SELECT Count(distinct UIN) kentucky_cnf_students FROM Applicants where UGCollege = 'Kentucky Wesleyan College' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					kentuckycnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Kentucky Wesleyan College' and term_cd='"&AdmitTerm&"'"
...
'rs.Open query,conn
    ...
    '//////// Kenyon Students ////////////
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_kenyon_query="SELECT Count(distinct UIN) kenyon_cnf_students FROM Applicants where UGCollege = 'Kenyon College' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					kenyoncnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Kenyon College' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_lakeforest_query="SELECT Count(distinct UIN) lakeforest_cnf_students FROM Applicants where UGCollege = 'Lake Forest College' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					lakeforestcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Lake Forest College' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_lawrence_query="SELECT Count(distinct UIN) lawrence_cnf_students FROM Applicants where UGCollege = 'Lawrence University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					lawrencecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Lawrence University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_lewis_query="SELECT Count(distinct UIN) lewis_cnf_students FROM Applicants where UGCollege = 'Lewis University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					lewiscnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Lewis University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_lincolnuniv_query="SELECT Count(distinct UIN) lincolnuniv_cnf_students FROM Applicants where UGCollege = 'Lincoln University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					lincolnunivcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Lincoln University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_lindenwood_query="SELECT Count(distinct UIN) lindenwood_cnf_students FROM Applicants where UGCollege = 'Lindenwood University-Belleville' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					lindenwoodcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Lindenwood University-Belleville' and term_cd='"&AdmitTerm&"'"
...
'//////// loras Students ////////////
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_loras_query="SELECT Count(distinct UIN) loras_cnf_students FROM Applicants where UGCollege = 'loras College' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					lorascnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'loras College' and term_cd='"&AdmitTerm&"'"
 ...
 rs.close    
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_loyola_query="SELECT Count(distinct UIN) loyola_cnf_students FROM Applicants where UGCollege = 'Loyola University Chicago' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					loyolacnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Loyola University Chicago' and term_cd='"&AdmitTerm&"'"
 ...
 rs.close 
  ...
  Else
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_luther_query="SELECT Count(distinct UIN) luther_cnf_students FROM Applicants where UGCollege = 'Luther College' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					luthercnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Luther College' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_macalester_query="SELECT Count(distinct UIN) macalester_cnf_students FROM Applicants where UGCollege = 'Macalester College' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					macalestercnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Macalester College' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_marquette_query="SELECT Count(distinct UIN) marquette_cnf_students FROM Applicants where UGCollege = 'Marquette University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					marquettecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Marquette University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_miami_query="SELECT Count(distinct UIN) miami_cnf_students FROM Applicants where UGCollege = 'Miami University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					miamicnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Miami University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_miamioxford_query="SELECT Count(distinct UIN) miamioxford_cnf_students FROM Applicants where UGCollege = 'Miami University-Oxford Ohio' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					miamioxfordcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Miami University-Oxford Ohio' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_msu_query="SELECT Count(distinct UIN) msu_cnf_students FROM Applicants where UGCollege = 'Michigan State University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					msucnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Michigan State University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_moddybible_query="SELECT Count(distinct UIN) moddybible_cnf_students FROM Applicants where UGCollege = 'Moddy Bible Institute' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					moddybiblecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Moddy Bible Institute' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_nationallouis_query="SELECT Count(distinct UIN) nationallouis_cnf_students FROM Applicants where UGCollege = 'National Louis University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					nationallouiscnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'National Louis University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_nyu_query="SELECT Count(distinct UIN) nyu_cnf_students FROM Applicants where UGCollege = 'New York University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					nyucnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'New York University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_northcentral_query="SELECT Count(distinct UIN) northcentral_cnf_students FROM Applicants where UGCollege = 'North Central College' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					northcentralcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'North Central College' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_northpark_query="SELECT Count(distinct UIN) northpark_cnf_students FROM Applicants where UGCollege = 'North Park University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					northparkcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'North Park University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_northeasternillinois_query="SELECT Count(distinct UIN) northeasternillinois_cnf_students FROM Applicants where UGCollege = 'Northeastern Illinois University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					northeasternillinoiscnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Northeastern Illinois University' and term_cd='"&AdmitTerm&"'"
...
'//////// Northern Arizona University Students ////////////
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_northernarizona_query="SELECT Count(distinct UIN) northernarizona_cnf_students FROM Applicants where UGCollege = 'Northern Arizona University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					northernarizonacnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Northern Arizona University' and term_cd='"&AdmitTerm&"'"
...
'//////// Northern Michigan Students ////////////
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_northernmichigan_query="SELECT Count(distinct UIN) northernmichigan_cnf_students FROM Applicants where UGCollege = 'Northern Michigan University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					northernmichigancnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Northern Michigan University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_northernillinois_query="SELECT Count(distinct UIN) northernillinois_cnf_students FROM Applicants where UGCollege = 'Northern Illinois University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					northernillinoiscnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Northern Illinois University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_northwest_query="SELECT Count(distinct UIN) northwest_cnf_students FROM Applicants where UGCollege = 'Northwest University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					northwestcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Northwest University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_northwestern_query="SELECT Count(distinct UIN) northwestern_cnf_students FROM Applicants where UGCollege = 'Northwestern University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					northwesterncnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Northwestern University' and term_cd='"&AdmitTerm&"'"
...
'//////// Ohio State Students ////////////
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_ohiostate_query="SELECT Count(distinct UIN) ohiostate_cnf_students FROM Applicants where UGCollege = 'Ohio State University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					ohiostatecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Ohio State University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_olivet_query="SELECT Count(distinct UIN) olivet_cnf_students FROM Applicants where UGCollege = 'Olivet Nazarene University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					olivetcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Olivet Nazarene University' and term_cd='"&AdmitTerm&"'"
 ...
 rs.close    
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_pennsylvaniastate_query="SELECT Count(distinct UIN) pennsylvaniastate_cnf_students FROM Applicants where UGCollege = 'Pennsylvania State University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					pennsylvaniastatecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Pennsylvania State University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_portlandstate_query="SELECT Count(distinct UIN) portlandstate_cnf_students FROM Applicants where UGCollege = 'Portland State University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					portlandstatecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Portland State University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_purdue_query="SELECT Count(distinct UIN) purdue_cnf_students FROM Applicants where UGCollege = 'Purdue University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					purduecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Purdue University' and term_cd='"&AdmitTerm&"'"
 ...
 rs.close    
    ...
    '//////// Quincy Students ////////////
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_quincy_query="SELECT Count(distinct UIN) quincy_cnf_students FROM Applicants where UGCollege = 'Quincy University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					quincycnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Quincy University' and term_cd='"&AdmitTerm&"'"
 ...
 rs.close    
    ...
    '//////// Rice Students ////////////
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_rice_query="SELECT Count(distinct UIN) rice_cnf_students FROM Applicants where UGCollege = 'Rice University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					ricecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Rice University' and term_cd='"&AdmitTerm&"'"
...
'//////// Roosevelt Students ////////////
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_roosevelt_query="SELECT Count(distinct UIN) roosevelt_cnf_students FROM Applicants where UGCollege = 'Roosevelt University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					rooseveltcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Roosevelt University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_saintLouis_query="SELECT Count(distinct UIN) saintLouis_cnf_students FROM Applicants where UGCollege = 'Saint Louis University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					saintLouiscnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Saint Louis University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_saintxavier_query="SELECT Count(distinct UIN) saintxavier_cnf_students FROM Applicants where UGCollege = 'Saint Xavier University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					saintxaviercnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Saint Xavier University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_sanfrancisco_query="SELECT Count(distinct UIN) sanfrancisco_cnf_students FROM Applicants where UGCollege = 'San Francisco State University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					sanfranciscocnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'San Francisco State University' and term_cd='"&AdmitTerm&"'"
...
'//////// Santa Clara University Students ////////////
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_santaclara_query="SELECT Count(distinct UIN) santaclara_cnf_students FROM Applicants where UGCollege = 'Santa Clara University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					santaclaracnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Santa Clara University' and term_cd='"&AdmitTerm&"'"
...
'//////// Skidmore Students ////////////
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_skidmore_query="SELECT Count(distinct UIN) skidmore_cnf_students FROM Applicants where UGCollege = 'Skidmore College' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					skidmorecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Skidmore College' and term_cd='"&AdmitTerm&"'"
...
'//////// Smith College Students ////////////
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_smith_query="SELECT Count(distinct UIN) smith_cnf_students FROM Applicants where UGCollege = 'Smith College' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					smithcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Smith College' and term_cd='"&AdmitTerm&"'"
...
'//////// South Dakota State University Students ////////////
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_southdakota_query="SELECT Count(distinct UIN) southdakota_cnf_students FROM Applicants where UGCollege = 'South Dakota State University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					southdakotacnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'South Dakota State University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_southernillinoiscarbondale_query="SELECT Count(distinct UIN) southernillinoiscarbondale_cnf_students FROM Applicants where UGCollege = 'Southern Illinois University Carbondale' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					southernillinoiscarbondalecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Southern Illinois University Carbondale' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_southernillinoisedwardsville_query="SELECT Count(distinct UIN) southernillinoisedwardsville_cnf_students FROM Applicants where UGCollege = 'Southern Illinois University Edwardsville' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					southernillinoisedwardsvillecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Southern Illinois University Edwardsville' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_southernnewhampshire_query="SELECT Count(distinct UIN) southernnewhampshire_cnf_students FROM Applicants where UGCollege = 'Southern New Hampshire University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					southernnewhampshirecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Southern New Hampshire University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_southerncarbondale_query="SELECT Count(distinct UIN) southerncarbondale_cnf_students FROM Applicants where UGCollege = 'Southern University Carbondale' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					southerncarbondalecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Southern University Carbondale' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_staugustine_query="SELECT Count(distinct UIN) staugustine_cnf_students FROM Applicants where UGCollege = 'St Augustine College' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					staugustinecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'St Augustine College' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_stmarys_query="SELECT Count(distinct UIN) stmarys_cnf_students FROM Applicants where UGCollege = 'St. Marys College' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					stmaryscnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'St. Marys College' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_stnorbert_query="SELECT Count(distinct UIN) stnorbert_cnf_students FROM Applicants where UGCollege = 'St. Norbert College' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					stnorbertcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'St. Norbert College' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_stxavier_query="SELECT Count(distinct UIN) stxavier_cnf_students FROM Applicants where UGCollege = 'St. Xavier University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					stxaviercnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'St. Xavier University' and term_cd='"&AdmitTerm&"'"
 ...
 rs.close    
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_SUNYbinghampton_query="SELECT Count(distinct UIN) SUNYbinghampton_cnf_students FROM Applicants where UGCollege = 'State University of New York Binghampton' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					SUNYbinghamptoncnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'State University of New York Binghampton' and term_cd='"&AdmitTerm&"'"
 ...
 rs.close 
  ...
  Else
    ...
    '//////// Taylor Students ////////////
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_taylor_query="SELECT Count(distinct UIN) taylor_cnf_students FROM Applicants where UGCollege = 'Taylor University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					taylorcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Taylor University' and term_cd='"&AdmitTerm&"'"
...
'rs.Open query,conn
    ...
    '//////// Temple Students ////////////
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_temple_query="SELECT Count(distinct UIN) temple_cnf_students FROM Applicants where UGCollege = 'Temple University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					templecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Temple University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_tennessee_query="SELECT Count(distinct UIN) tennessee_cnf_students FROM Applicants where UGCollege = 'Tennessee State University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					tennesseecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Tennessee State University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_texasstate_query="SELECT Count(distinct UIN) texasstate_cnf_students FROM Applicants where UGCollege = 'Texas State University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					texasstatecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Texas State University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_touro_query="SELECT Count(distinct UIN) touro_cnf_students FROM Applicants where UGCollege = 'Touro College' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					tourocnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Touro College' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_trinity_query="SELECT Count(distinct UIN) trinity_cnf_students FROM Applicants where UGCollege = 'Trinity Christian College' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					trinitycnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Trinity Christian College' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_trumanstate_query="SELECT Count(distinct UIN) trumanstate_cnf_students FROM Applicants where UGCollege = 'Truman State University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					trumanstatecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Truman State University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_tufts_query="SELECT Count(distinct UIN) tufts_cnf_students FROM Applicants where UGCollege = 'Tufts University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					tuftscnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Tufts University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_united_query="SELECT Count(distinct UIN) united_cnf_students FROM Applicants where UGCollege = 'United International College' and  term_cd='"&AdmitTerm&"'"
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					unitedcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'United International College' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_universityofalabama_query="SELECT Count(distinct UIN) universityofalabama_cnf_students FROM Applicants where UGCollege = 'University of Alabama' and  term_cd='"&AdmitTerm&"'"
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					universityofalabamacnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of Alabama' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_universityofcaliforniaBerkeley_query="SELECT Count(distinct UIN) universityofcaliforniaBerkeley_cnf_students FROM Applicants where UGCollege = 'University of California Berkeley' and  term_cd='"&AdmitTerm&"'"
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					universityofcaliforniaBerkeleycnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of California Berkeley' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_universityofcaliforniairvine_query="SELECT Count(distinct UIN) universityofcaliforniairvine_cnf_students FROM Applicants where UGCollege = 'University of California Irvine' and  term_cd='"&AdmitTerm&"'"
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					universityofcaliforniairvinecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of California Irvine' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_universityofcaliforniasan_query="SELECT Count(distinct UIN) universityofcaliforniasan_cnf_students FROM Applicants where UGCollege = 'University of California San Diego' and  term_cd='"&AdmitTerm&"'"
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					universityofcaliforniasancnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of California San Diego' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_universityofcaliforniabarbara_query="SELECT Count(distinct UIN) universityofcaliforniabarbara_cnf_students FROM Applicants where UGCollege = 'University of California Santa Barbara' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					universityofcaliforniabarbaracnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of California Santa Barbara' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_universityofcalifornia_query="SELECT Count(distinct UIN) universityofcalifornia_cnf_students FROM Applicants where UGCollege = 'University of California Santa Cruz' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					universityofcaliforniacnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of California Santa Cruz' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_universityofchicago_query="SELECT Count(distinct UIN) universityofchicago_cnf_students FROM Applicants where UGCollege = 'University of Chicago' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					universityofchicagocnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of Chicago' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_universityofCincinnati_query="SELECT Count(distinct UIN) universityofCincinnati_cnf_students FROM Applicants where UGCollege = 'University of Cincinnati' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					universityofCincinnaticnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of Cincinnati' and term_cd='"&AdmitTerm&"'"
...
'rs.Open query,conn
    ...
    '//////// Dayton Students ////////////
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_dayton_query="SELECT Count(distinct UIN) dayton_cnf_students FROM Applicants where UGCollege = 'University of Dayton' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					daytoncnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of Dayton' and term_cd='"&AdmitTerm&"'"
 ...
 rs.close    
    ...
    '//////// Evansville Students ////////////
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_evansville_query="SELECT Count(distinct UIN) evansville_cnf_students FROM Applicants where UGCollege = 'University of Evansville' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					evansvillecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of Evansville' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_univgeorgia_query="SELECT Count(distinct UIN) univgeorgia_cnf_students FROM Applicants where UGCollege = 'University of Georgia' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					univgeorgiacnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of Georgia' and term_cd='"&AdmitTerm&"'"
...
'//////// UIC Students ////////////
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_uic_query="SELECT Count(distinct UIN) uic_cnf_students FROM Applicants where UGCollege = 'University of Illinois Chicago' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					uiccnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of Illinois Chicago' and term_cd='"&AdmitTerm&"'"
...
'//////// UIS Students ////////////
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_uis_query="SELECT Count(distinct UIN) uis_cnf_students FROM Applicants where UGCollege = 'University of Illinois Springfield' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					uiscnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of Illinois Springfield' and term_cd='"&AdmitTerm&"'"
...
'//////// University of Illinois Urbana Students ////////////
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_universityurbana_query="SELECT Count(distinct UIN) universityurbana_cnf_students FROM Applicants where UGCollege = 'University of Illinois Urbana' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					universityurbanacnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of Illinois Urbana' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_urbanachampaign_query="SELECT Count(distinct UIN) urbanachampaign_cnf_students FROM Applicants where UGCollege = 'University of Illinois Urbana Champaign' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					urbanachampaigncnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of Illinois Urbana Champaign' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_iowa_query="SELECT Count(distinct UIN) iowa_cnf_students FROM Applicants where UGCollege = 'University of Iowa' and  Term_CD like '"&AdmitTerm&"' "
rs.Open cnf_students_iowa_query,conn
    If rs("iowa_cnf_students") <> 0 Then 
    pdf.GreyTitle("University of Iowa")
'pdf.FancyTable()

iowa_cnf_rows = rs("iowa_cnf_students")
iowa_cnf_cols = 5
Dim iowa_cnf_col(5)
iowa_cnf_col(1) = "Banner # "
iowa_cnf_col(2) = "First Name"
iowa_cnf_col(3) = "Last Name"
iowa_cnf_col(4) = "Applied"
iowa_cnf_col(5) = "Confirmed"
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					iowacnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of Iowa' and term_cd='"&AdmitTerm&"'"
					rs.Open iowacnf_query,conn 
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_univkansas_query="SELECT Count(distinct UIN) univkansas_cnf_students FROM Applicants where UGCollege = 'University of Kansas' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					univkansascnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of Kansas' and term_cd='"&AdmitTerm&"'"
 ...
 rs.close    
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_massachusetts_query="SELECT Count(distinct UIN) massachusetts_cnf_students FROM Applicants where UGCollege = 'University of Massachusetts Amherst' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					massachusettscnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of Massachusetts Amherst' and term_cd='"&AdmitTerm&"'"
 ...
 rs.close 
  ...
  Else
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_univmichigan_query="SELECT Count(distinct UIN) univmichigan_cnf_students FROM Applicants where UGCollege = 'University of Michigan' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					univmichigancnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of Michigan' and term_cd='"&AdmitTerm&"'"
 ...
 rs.close 
  ...
  Else
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_univmichiganann_query="SELECT Count(distinct UIN) univmichiganann_cnf_students FROM Applicants where UGCollege = 'University of Michigan Ann Arbor' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					univmichigananncnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of Michigan Ann Arbor' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_minnesota_query="SELECT Count(distinct UIN) minnesota_cnf_students FROM Applicants where UGCollege = 'University of Minnesota Twin Cities' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					minnesotacnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of Minnesota Twin Cities' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_missouristlouis_query="SELECT Count(distinct UIN) missouristlouis_cnf_students FROM Applicants where UGCollege = 'University of Missouri - St. Louis' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					missouristlouiscnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of Missouri - St. Louis' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_missouri_query="SELECT Count(distinct UIN) missouri_cnf_students FROM Applicants where UGCollege = 'University of Missouri Columbia' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					missouricnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of Missouri Columbia' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_nebraskalincoln_query="SELECT Count(distinct UIN) nebraskalincoln_cnf_students FROM Applicants where UGCollege = 'University of Nebraska Lincoln' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					nebraskalincolncnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of Nebraska Lincoln' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_newhampshire_query="SELECT Count(distinct UIN) newhampshire_cnf_students FROM Applicants where UGCollege = 'University of New Hampshire' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					newhampshirecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of New Hampshire' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_nigeria_query="SELECT Count(distinct UIN) nigeria_cnf_students FROM Applicants where UGCollege = 'University of Nigeria' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					nigeriacnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of Nigeria' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_nortedame_query="SELECT Count(distinct UIN) nortedame_cnf_students FROM Applicants where UGCollege = 'University of Norte Dame' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					nortedamecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of Norte Dame' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_uncch_query="SELECT Count(distinct UIN) uncch_cnf_students FROM Applicants where UGCollege = 'University of North Carolina Chapel Hill' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					uncchcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of North Carolina Chapel Hill' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_wilmington_query="SELECT Count(distinct UIN) wilmington_cnf_students FROM Applicants where UGCollege = 'University of North Carolina Wilmington' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					wilmingtoncnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of North Carolina Wilmington' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_northdakota_query="SELECT Count(distinct UIN) northdakota_cnf_students FROM Applicants where UGCollege = 'University of North Dakota' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					northdakotacnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of North Dakota' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_oregon_query="SELECT Count(distinct UIN) oregon_cnf_students FROM Applicants where UGCollege = 'University of Oregon' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					oregoncnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of Oregon' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_pittsburgh_query="SELECT Count(distinct UIN) pittsburgh_cnf_students FROM Applicants where UGCollege = 'University of Pittsburgh' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					pittsburghcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of Pittsburgh' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_redlands_query="SELECT Count(distinct UIN) redlands_cnf_students FROM Applicants where UGCollege = 'University of Redlands' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					redlandscnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of Redlands' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_rochester_query="SELECT Count(distinct UIN) rochester_cnf_students FROM Applicants where UGCollege = 'University of Rochester' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					rochestercnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of Rochester' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_Scranton_query="SELECT Count(distinct UIN) Scranton_cnf_students FROM Applicants where UGCollege = 'University of Scranton' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					Scrantoncnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of Scranton' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_southcarolina_query="SELECT Count(distinct UIN) southcarolina_cnf_students FROM Applicants where UGCollege = 'University of South Carolina' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					southcarolinacnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of South Carolina' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_southcarolinaColumbia_query="SELECT Count(distinct UIN) southcarolinaColumbia_cnf_students FROM Applicants where UGCollege = 'University of South Carolina Columbia' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					southcarolinaColumbiacnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of South Carolina Columbia' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_austin_query="SELECT Count(distinct UIN) austin_cnf_students FROM Applicants where UGCollege = 'University of Texas Austin' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					austincnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of Texas Austin' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_toledo_query="SELECT Count(distinct UIN) toledo_cnf_students FROM Applicants where UGCollege = 'University of Toledo' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					toledocnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of Toledo' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_vermont_query="SELECT Count(distinct UIN) vermont_cnf_students FROM Applicants where UGCollege = 'University of Vermont' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					vermontcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of Vermont' and term_cd='"&AdmitTerm&"'"
...
'//////// University of Washington Students ////////////
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_washington_query="SELECT Count(distinct UIN) washington_cnf_students FROM Applicants where UGCollege = 'University of Washington' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					washingtoncnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of Washington' and term_cd='"&AdmitTerm&"'"
...
'//////// University of Washington Seattle Students ////////////
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_washingtonseattle_query="SELECT Count(distinct UIN) washingtonseattle_cnf_students FROM Applicants where UGCollege = 'University of Washington Seattle' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					washingtonseattlecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of Washington Seattle' and term_cd='"&AdmitTerm&"'"
...
'//////// University of Wisconsin Eau Claire Students ////////////
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_wisconsineauclaire_query="SELECT Count(distinct UIN) wisconsineauclaire_cnf_students FROM Applicants where UGCollege = 'University of Wisconsin Eau Claire' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					wisconsineauclairecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of Wisconsin Eau Claire' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_wisconsinlacrosse_query="SELECT Count(distinct UIN) wisconsinlacrosse_cnf_students FROM Applicants where UGCollege = 'University of Wisconsin La Crosse' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					wisconsinlacrossecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of Wisconsin La Crosse' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_wisconsinmadison_query="SELECT Count(distinct UIN) wisconsinmadison_cnf_students FROM Applicants where UGCollege = 'University of Wisconsin Madison' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					wisconsinmadisoncnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of Wisconsin Madison' and term_cd='"&AdmitTerm&"'"
...
'//////// University of Wisconsin Milwaukee Students ////////////
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_wisconsinmilwaukee_query="SELECT Count(distinct UIN) wisconsinmilwaukee_cnf_students FROM Applicants where UGCollege = 'University of Wisconsin Milwaukee' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					wisconsinmilwaukeecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'University of Wisconsin Milwaukee' and term_cd='"&AdmitTerm&"'"
...
'//////// Upper Iowa University Students ////////////
    ...
    set rs=Server.CreateObject("ADODB.recordset")
cnf_students_upperiowa_query="SELECT Count(distinct UIN) upperiowa_cnf_students FROM Applicants where UGCollege = 'Upper Iowa University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					upperiowacnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Upper Iowa University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_valparaiso_query="SELECT Count(distinct UIN) valparaiso_cnf_students FROM Applicants where UGCollege = 'Valparaiso University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					valparaisocnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Valparaiso University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_villanova_query="SELECT Count(distinct UIN) villanova_cnf_students FROM Applicants where UGCollege = 'Villanova University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					villanovacnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Villanova University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_wesleyanuniv_query="SELECT Count(distinct UIN) wesleyanuniv_cnf_students FROM Applicants where UGCollege = 'Wesleyan University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					wesleyanunivcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Wesleyan University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_westchester_query="SELECT Count(distinct UIN) westchester_cnf_students FROM Applicants where UGCollege = 'West Chester University of Pennsylvania' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					westchestercnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'West Chester University of Pennsylvania' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_westernillinois_query="SELECT Count(distinct UIN) westernillinois_cnf_students FROM Applicants where UGCollege = 'Western Illinois University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					westernillinoiscnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Western Illinois University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_westernmichigan_query="SELECT Count(distinct UIN) westernmichigan_cnf_students FROM Applicants where UGCollege = 'Western Michigan University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					westernmichigancnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Western Michigan University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_westernwashington_query="SELECT Count(distinct UIN) westernwashington_cnf_students FROM Applicants where UGCollege = 'Western Washington University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					westernwashingtoncnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Western Washington University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_westwood_query="SELECT Count(distinct UIN) westwood_cnf_students FROM Applicants where UGCollege = 'Westwood College' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					westwoodcnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Westwood College' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_wheaton_query="SELECT Count(distinct UIN) wheaton_cnf_students FROM Applicants where UGCollege = 'Wheaton College' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					wheatoncnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Wheaton College' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_winona_query="SELECT Count(distinct UIN) winona_cnf_students FROM Applicants where UGCollege = 'Winona State University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					winonacnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Winona State University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_xavier_query="SELECT Count(distinct UIN) xavier_cnf_students FROM Applicants where UGCollege = 'Xavier University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					xaviercnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Xavier University' and term_cd='"&AdmitTerm&"'"
...
set rs=Server.CreateObject("ADODB.recordset")
cnf_students_yale_query="SELECT Count(distinct UIN) yale_cnf_students FROM Applicants where UGCollege = 'Yale University' and  Term_CD like '"&AdmitTerm&"' "
...
pdf.SetFont "Arial","",10
					...
					rs.close
					set rs=Server.CreateObject("ADODB.recordset")
					yalecnf_query="SELECT UIN, Firstname, LastName, Admission_decision, Confirmed FROM Applicants where UGCollege = 'Yale University' and term_cd='"&AdmitTerm&"'"
